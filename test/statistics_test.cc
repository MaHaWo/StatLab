...
auto
generate_sample(std::size_t    samplesize,
                std::size_t    seed,
                Distribution&& dist,
                bool           write)
{
...
main()
{
    auto data = generate_sample(
        10000, 75843, std::normal_distribution< double >(0, 5), true);
    ...
    double pythonkahansum =
        429.4514075442959; // put fucking floating point to 1.....
